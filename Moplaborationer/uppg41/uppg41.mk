...
ProjectPath            :="E:/DAT017/CodeLite files/Moplaborationer/uppg41"
...
PostBuild:
	...
	arm-none-eabi-objcopy -S -O srec  ./Debug/uppg41.elf ./Debug/uppg41.s19
	arm-none-eabi-objdump -D -S ./Debug/uppg41.elf > ./Debug/uppg41.dass
	@echo Done
...
$(IntermediateDirectory)/startup.c$(ObjectSuffix): startup.c $(IntermediateDirectory)/startup.c$(DependSuffix)
	$(CC) $(SourceSwitch) "E:/DAT017/CodeLite files/Moplaborationer/uppg41/startup.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/gpio.c$(ObjectSuffix): gpio.c $(IntermediateDirectory)/gpio.c$(DependSuffix)
	$(CC) $(SourceSwitch) "E:/DAT017/CodeLite files/Moplaborationer/uppg41/gpio.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/gpio.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/sys_delay.c$(ObjectSuffix): sys_delay.c $(IntermediateDirectory)/sys_delay.c$(DependSuffix)
	$(CC) $(SourceSwitch) "E:/DAT017/CodeLite files/Moplaborationer/uppg41/sys_delay.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/sys_delay.c$(ObjectSuffix) $(IncludePath)
