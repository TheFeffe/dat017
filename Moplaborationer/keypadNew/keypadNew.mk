...
##
## Debug
ProjectName            :=keypadNew
ConfigurationName      :=Debug
WorkspacePath          :="E:/DAT017/CodeLite files/Moplaborationer"
ProjectPath            :="E:/DAT017/CodeLite files/Moplaborationer/keypadNew"
...
PostBuild:
	...
	arm-none-eabi-objcopy -S -O srec  ./Debug/keypadNew.elf ./Debug/keypadNew.s19
	arm-none-eabi-objdump -D -S ./Debug/keypadNew.elf > ./Debug/keypadNew.dass
	@echo Done
...
$(IntermediateDirectory)/startup.c$(ObjectSuffix): startup.c $(IntermediateDirectory)/startup.c$(DependSuffix)
	$(CC) $(SourceSwitch) "E:/DAT017/CodeLite files/Moplaborationer/keypadNew/startup.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup.c$(ObjectSuffix) $(IncludePath)
